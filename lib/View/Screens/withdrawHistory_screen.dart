...
class WithdawHistroyScreen extends StatelessWidget {
  WithdawHistroyScreen({Key? key}) : super(key: key);
  @override
  ...
  Widget buildDataWidget(BuildContext context) {
    final gamesController = Provider.of<WithdrawHistoryC>(
      context,
      listen: false,
    );
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      child: Center(child: Text(game.amount))),
                                  Expanded(child: Text(game.type)),
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: game.transactionStatus == 'failed'
                                          ? Colors.red
                                          : game.transactionStatus == 'pending'
                                              ? Colors.yellow
                                              : Colors.green,
                                    ),
                                    child: Center(
